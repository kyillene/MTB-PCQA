...
# filter based on codec information.
# if file organization is not similar, and codec information is not included in file name, please filter based on your file organization.
codec = 'predlift'  # alternatives are: 'geocnn', 'predlift', 'raht', 'vpcc' in BASICS dataset.
gt = gt[gt['ppc'].str.contains(codec)]
preds = preds[preds['ppc'].str.contains(codec)]
